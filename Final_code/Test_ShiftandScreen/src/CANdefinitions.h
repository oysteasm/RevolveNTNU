 ...
 * CANdefinitions.h
 *
 * Created: 31.03.2014 21:05:21
 *  Author: Øystein
 */ 


#ifndef CANDEFINITIONS_H_
#define CANDEFINITIONS_H_
...
#define CANR_GRP_BMS_ID					0x27		// BMS-data
...
#define CANR_GRP_AUDIO_ID				0x88		// DAVE
#define CANR_GRP_ADC_ID					0x98		// ADC
...
#define DASH_ALIVE_ECU				0x0
#define DASH_ALIVE_TRQ				0x1
#define DASH_ALIVE_BSPD				0x3
#define DASH_ALIVE_TELEMETRY		0x4
#define DASH_ALIVE_DATALOGGER		0x5
#define DASH_ALIVE_ADC				0x6
#define DASH_ALIVE_CCU				0x8
#define DASH_ALIVE_FAN				0x9
#define DASH_ALIVE_BMS				0xA
#define DASH_ALIVE_STEERANG			0xB
#define DASH_ALIVE_WCU				0xC
...
#define	ECU_DATA_CH0 CANR_FCN_DATA_ID|CANR_GRP_ECU_ID
#define ECU_DATA_CH0_ID0 CANR_FCN_DATA_ID|CANR_GRP_ECU_ID|CANR_MODULE_ID0_ID
#define ECU_DATA_CH0_ID1 CANR_FCN_DATA_ID|CANR_GRP_ECU_ID|CANR_MODULE_ID1_ID
#define	ECU_CMD_CH0 CANR_FCN_CMD_ID|CANR_GRP_ECU_ID
#define ECU_CMD_CH0_ID0 CANR_FCN_CMD_ID|CANR_GRP_ECU_ID|CANR_MODULE_ID0_ID
#define ECU_CMD_CH0_ID1 CANR_FCN_CMD_ID|CANR_GRP_ECU_ID|CANR_MODULE_ID1_ID
#define ECU_PRI_CH0 CANR_FCN_PRI_ID|CANR_GRP_ECU_ID

#define DASH_CMD CANR_FCN_CMD_ID|CANR_GRP_DASH_ID
#define DASH_CMD_ID0  DASH_CMD|CANR_MODULE_ID0_ID
#define DASH_CMD_ID1  DASH_CMD|CANR_MODULE_ID1_ID
#define DASH_PRI_ID1  CANR_FCN_PRI_ID|CANR_GRP_DASH_ID|CANR_MODULE_ID1_ID
#define DASH_PRI_ID0  CANR_FCN_PRI_ID|CANR_GRP_DASH_ID|CANR_MODULE_ID0_ID
#define DASH_PRI_ID2  CANR_FCN_PRI_ID|CANR_GRP_DASH_ID|CANR_MODULE_ID2_ID
#define DASH_PRI_ID3  CANR_FCN_PRI_ID|CANR_GRP_DASH_ID|CANR_MODULE_ID3_ID
#define DASH_PRI_ID4  CANR_FCN_PRI_ID|CANR_GRP_DASH_ID|CANR_MODULE_ID4_ID
#define DASH_PRI_ID5  CANR_FCN_PRI_ID|CANR_GRP_DASH_ID|CANR_MODULE_ID5_ID
#define ISALIVE CANR_FCN_DATA_ID|CANR_GRP_DASH_ID
#define BSPD_DATA_CH0 CANR_FCN_DATA_ID|CANR_GRP_SENS_BSPD_ID
#define BSPD_DATA_CH0_ID0 CANR_FCN_DATA_ID|CANR_GRP_SENS_BSPD_ID|CANR_MODULE_ID0_ID
#define TRQENC_PRI CANR_FCN_PRI_ID|CANR_GRP_SENS_TRQ_ID
#define BMS_CMD_CH0 (CANR_FCN_CMD_ID|CANR_GRP_BMS_ID)
//#define ISALIVE CANR_FCN_DATA_ID|CANR_GRP_DASH_ID|CANR_MODULE_ID7_ID
#define BMS_CMD_MOD6 CANR_FCN_CMD_ID|CANR_GRP_BMS_ID|CANR_MODULE_ID6_ID
#define DASH_DATA CANR_FCN_DATA_ID|CANR_GRP_DASH_ID
#define TELEMETRY_DATA CANR_GRP_TELEMETRY_ID | CANR_FCN_DATA_ID
#define ADC_DATA CANR_FCN_DATA_ID|CANR_GRP_ADC_ID
#define STRANG_DATA CANR_FCN_DATA_ID|CANR_GRP_SENS_STEER_ID
#define GEARTMP_DATA CANR_FCN_DATA_ID|CANR_GRP_SENS_GEAR_TEMP_ID
#define GLV_DATA CANR_FCN_DATA_ID|CANR_GRP_SENS_VOLT_ID
